...
func (o *City) GetAddresses() AddressSlice {
	if o == nil {
		return nil
	}

	return o.R.GetAddresses()
}
...
// OneG returns a single city record from the query using the global executor.
func (q cityQuery) OneG(ctx context.Context) (*City, error) {
...
// AllG returns all City records from the query using the global executor.
func (q cityQuery) AllG(ctx context.Context) (CitySlice, error) {
...
// CountG returns the count of all City records in the query using the global executor
func (q cityQuery) CountG(ctx context.Context) (int64, error) {
...
func (q cityQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (o *City) SetCountryG(ctx context.Context, insert bool, related *Country) error {
...
// Uses the global database handle.
func (o *City) AddAddressesG(ctx context.Context, insert bool, related ...*Address) error {
...
func FindCityG(ctx context.Context, cityID uint16, selectCols ...string) (*City, error) {
	return FindCity(ctx, boil.GetContextDB(), cityID, selectCols...)
}
...
func (o *City) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *City) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for city")
	}
...
// UpdateG a single City record using the global executor.
// See Update for more documentation.
func (o *City) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q cityQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o CitySlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *City) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *City) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for city")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for city")
	}
...
func (o *City) DeleteG(ctx context.Context) (int64, error) {
...
func (q cityQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o CitySlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *City) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no City provided for reload")
	}
...
func (o *CitySlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty CitySlice provided for reload all")
	}
...
func CityExistsG(ctx context.Context, cityID uint16) (bool, error) {
	return CityExists(ctx, boil.GetContextDB(), cityID)
}
