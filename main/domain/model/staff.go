...
func (o *Staff) GetAddress() *Address {
	if o == nil {
		return nil
	}
...
func (o *Staff) GetManagerStaffStore() *Store {
	if o == nil {
		return nil
	}

	return o.R.GetManagerStaffStore()
}
...
func (o *Staff) GetPayments() PaymentSlice {
	if o == nil {
		return nil
	}
...
func (o *Staff) GetRentals() RentalSlice {
	if o == nil {
		return nil
	}
...
func (q staffQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Staff, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for staff")
	}
...
func (q staffQuery) All(ctx context.Context, exec boil.ContextExecutor) (StaffSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to Staff slice")
	}
...
func (q staffQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count staff rows")
	}
...
func (q staffQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if staff exists")
	}
...
func (o *Staff) SetAddressG(ctx context.Context, insert bool, related *Address) error {
...
// Adds o to related.R.Staffs.
// Uses the global database handle.
func (o *Staff) SetStoreG(ctx context.Context, insert bool, related *Store) error {
...
// Uses the global database handle.
func (o *Staff) SetManagerStaffStoreG(ctx context.Context, insert bool, related *Store) error {
	return o.SetManagerStaffStore(ctx, boil.GetContextDB(), insert, related)
}
...
// Uses the global database handle.
func (o *Staff) AddPaymentsG(ctx context.Context, insert bool, related ...*Payment) error {
...
// Sets related.R.Staff appropriately.
// Uses the global database handle.
func (o *Staff) AddRentalsG(ctx context.Context, insert bool, related ...*Rental) error {
...
func FindStaffG(ctx context.Context, staffID uint8, selectCols ...string) (*Staff, error) {
...
func FindStaff(ctx context.Context, exec boil.ContextExecutor, staffID uint8, selectCols ...string) (*Staff, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from staff")
	}
...
func (o *Staff) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no staff provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into staff")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for staff")
	}
...
func (o *Staff) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update staff, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update staff row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for staff")
	}
...
func (q staffQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for staff")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for staff")
	}
...
func (o StaffSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in staff slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all staff")
	}
	return rowsAff, nil
}
...
func (o *Staff) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no staff provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("model: unable to upsert staff, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for staff")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for staff")
	}
...
func (o *Staff) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no Staff provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from staff")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for staff")
	}
...
func (q staffQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no staffQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from staff")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for staff")
	}
...
func (o StaffSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from staff slice")
	}
...
func (o *Staff) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no Staff provided for reload")
	}
...
func (o *StaffSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty StaffSlice provided for reload all")
	}
...
func (o *StaffSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in StaffSlice")
	}
...
func StaffExistsG(ctx context.Context, staffID uint8) (bool, error) {
...
func StaffExists(ctx context.Context, exec boil.ContextExecutor, staffID uint8) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if staff exists")
	}
