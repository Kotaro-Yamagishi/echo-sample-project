...
func (o *Store) GetManagerStaff() *Staff {
	if o == nil {
		return nil
	}

	return o.R.GetManagerStaff()
}
...
func (o *Store) GetCustomers() CustomerSlice {
	if o == nil {
		return nil
	}

	return o.R.GetCustomers()
}
...
func (o *Store) GetInventories() InventorySlice {
	if o == nil {
		return nil
	}
...
func (o *Store) GetStaffs() StaffSlice {
	if o == nil {
		return nil
	}
...
func (q storeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Store, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for store")
	}
...
func (q storeQuery) All(ctx context.Context, exec boil.ContextExecutor) (StoreSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to Store slice")
	}
...
func (q storeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count store rows")
	}
...
func (q storeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if store exists")
	}
...
func (o *Store) SetAddressG(ctx context.Context, insert bool, related *Address) error {
...
// Uses the global database handle.
func (o *Store) SetManagerStaffG(ctx context.Context, insert bool, related *Staff) error {
	return o.SetManagerStaff(ctx, boil.GetContextDB(), insert, related)
}
...
// Sets related.R.Store appropriately.
// Uses the global database handle.
func (o *Store) AddInventoriesG(ctx context.Context, insert bool, related ...*Inventory) error {
...
func FindStoreG(ctx context.Context, storeID uint8, selectCols ...string) (*Store, error) {
...
func FindStore(ctx context.Context, exec boil.ContextExecutor, storeID uint8, selectCols ...string) (*Store, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from store")
	}
...
func (o *Store) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no store provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into store")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for store")
	}
...
func (o *Store) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update store, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update store row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for store")
	}
...
func (q storeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for store")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for store")
	}
...
func (o StoreSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in store slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all store")
	}
	return rowsAff, nil
}
...
func (o *Store) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no store provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("model: unable to upsert store, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for store")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for store")
	}
...
func (o *Store) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no Store provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from store")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for store")
	}
...
func (q storeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no storeQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from store")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for store")
	}
...
func (o StoreSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from store slice")
	}
...
func (o *Store) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no Store provided for reload")
	}
...
func (o *StoreSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty StoreSlice provided for reload all")
	}
...
func (o *StoreSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in StoreSlice")
	}
...
func StoreExistsG(ctx context.Context, storeID uint8) (bool, error) {
...
func StoreExists(ctx context.Context, exec boil.ContextExecutor, storeID uint8) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if store exists")
	}
