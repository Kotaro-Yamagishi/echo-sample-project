...
func (o *Payment) GetCustomer() *Customer {
	if o == nil {
		return nil
	}
...
func (o *Payment) GetRental() *Rental {
	if o == nil {
		return nil
	}

	return o.R.GetRental()
}
...
func (q paymentQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Payment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for payment")
	}
...
func (q paymentQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count payment rows")
	}
...
func (q paymentQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if payment exists")
	}
...
func (o *Payment) SetCustomerG(ctx context.Context, insert bool, related *Customer) error {
...
// Adds o to related.R.Payments.
// Uses the global database handle.
func (o *Payment) SetRentalG(ctx context.Context, insert bool, related *Rental) error {
	return o.SetRental(ctx, boil.GetContextDB(), insert, related)
}
...
// Uses the global database handle.
func (o *Payment) RemoveRentalG(ctx context.Context, related *Rental) error {
	return o.RemoveRental(ctx, boil.GetContextDB(), related)
}
...
// Adds o to related.R.Payments.
// Uses the global database handle.
func (o *Payment) SetStaffG(ctx context.Context, insert bool, related *Staff) error {
...
func FindPaymentG(ctx context.Context, paymentID uint16, selectCols ...string) (*Payment, error) {
...
func FindPayment(ctx context.Context, exec boil.ContextExecutor, paymentID uint16, selectCols ...string) (*Payment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from payment")
	}
...
func (o *Payment) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no payment provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into payment")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for payment")
	}
...
func (o *Payment) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update payment, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update payment row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for payment")
	}
...
func (q paymentQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for payment")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for payment")
	}
...
func (o *Payment) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *Payment) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no payment provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("model: unable to upsert payment, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for payment")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for payment")
	}
...
func (o *Payment) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from payment")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for payment")
	}
...
func (q paymentQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from payment")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for payment")
	}
...
func (o *Payment) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no Payment provided for reload")
	}
...
func (o *PaymentSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty PaymentSlice provided for reload all")
	}
...
func PaymentExistsG(ctx context.Context, paymentID uint16) (bool, error) {
...
func PaymentExists(ctx context.Context, exec boil.ContextExecutor, paymentID uint16) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if payment exists")
	}
