...
// OneG returns a single salesByFilmCategory record from the query using the global executor.
func (q salesByFilmCategoryQuery) OneG(ctx context.Context) (*SalesByFilmCategory, error) {
...
func (q salesByFilmCategoryQuery) One(ctx context.Context, exec boil.ContextExecutor) (*SalesByFilmCategory, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for sales_by_film_category")
	}
...
// AllG returns all SalesByFilmCategory records from the query using the global executor.
func (q salesByFilmCategoryQuery) AllG(ctx context.Context) (SalesByFilmCategorySlice, error) {
...
func (q salesByFilmCategoryQuery) All(ctx context.Context, exec boil.ContextExecutor) (SalesByFilmCategorySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to SalesByFilmCategory slice")
	}
...
// CountG returns the count of all SalesByFilmCategory records in the query using the global executor
func (q salesByFilmCategoryQuery) CountG(ctx context.Context) (int64, error) {
...
func (q salesByFilmCategoryQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count sales_by_film_category rows")
	}
...
func (q salesByFilmCategoryQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (q salesByFilmCategoryQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if sales_by_film_category exists")
	}
