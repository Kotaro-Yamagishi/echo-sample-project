...
// OneG returns a single salesByStore record from the query using the global executor.
func (q salesByStoreQuery) OneG(ctx context.Context) (*SalesByStore, error) {
...
func (q salesByStoreQuery) One(ctx context.Context, exec boil.ContextExecutor) (*SalesByStore, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for sales_by_store")
	}
...
// AllG returns all SalesByStore records from the query using the global executor.
func (q salesByStoreQuery) AllG(ctx context.Context) (SalesByStoreSlice, error) {
...
func (q salesByStoreQuery) All(ctx context.Context, exec boil.ContextExecutor) (SalesByStoreSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to SalesByStore slice")
	}
...
// CountG returns the count of all SalesByStore records in the query using the global executor
func (q salesByStoreQuery) CountG(ctx context.Context) (int64, error) {
...
func (q salesByStoreQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count sales_by_store rows")
	}
...
func (q salesByStoreQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (q salesByStoreQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if sales_by_store exists")
	}
