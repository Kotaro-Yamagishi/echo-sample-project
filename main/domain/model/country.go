...
func (countryL) LoadCities(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCountry interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`city`),
		qm.WhereIn(`city.country_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Country) AddCitiesG(ctx context.Context, insert bool, related ...*City) error {
	return o.AddCities(ctx, boil.GetContextDB(), insert, related...)
}
...
func FindCountryG(ctx context.Context, countryID uint16, selectCols ...string) (*Country, error) {
...
func (o *Country) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for country")
	}
...
func (o *Country) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *Country) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for country")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for country")
	}
...
func (o *Country) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no Country provided for reload")
	}
...
func (o *CountrySlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty CountrySlice provided for reload all")
	}
...
func CountryExistsG(ctx context.Context, countryID uint16) (bool, error) {
...
func (o *Country) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return CountryExists(ctx, exec, o.CountryID)
}
