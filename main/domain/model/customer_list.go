...
// OneG returns a single customerList record from the query using the global executor.
func (q customerListQuery) OneG(ctx context.Context) (*CustomerList, error) {
...
func (q customerListQuery) One(ctx context.Context, exec boil.ContextExecutor) (*CustomerList, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for customer_list")
	}
...
// AllG returns all CustomerList records from the query using the global executor.
func (q customerListQuery) AllG(ctx context.Context) (CustomerListSlice, error) {
...
func (q customerListQuery) All(ctx context.Context, exec boil.ContextExecutor) (CustomerListSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to CustomerList slice")
	}
...
// CountG returns the count of all CustomerList records in the query using the global executor
func (q customerListQuery) CountG(ctx context.Context) (int64, error) {
...
func (q customerListQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count customer_list rows")
	}
...
func (q customerListQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (q customerListQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if customer_list exists")
	}
