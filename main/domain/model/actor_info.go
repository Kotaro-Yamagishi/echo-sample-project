...
// OneG returns a single actorInfo record from the query using the global executor.
func (q actorInfoQuery) OneG(ctx context.Context) (*ActorInfo, error) {
...
func (q actorInfoQuery) One(ctx context.Context, exec boil.ContextExecutor) (*ActorInfo, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for actor_info")
	}
...
// AllG returns all ActorInfo records from the query using the global executor.
func (q actorInfoQuery) AllG(ctx context.Context) (ActorInfoSlice, error) {
...
func (q actorInfoQuery) All(ctx context.Context, exec boil.ContextExecutor) (ActorInfoSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to ActorInfo slice")
	}
...
// CountG returns the count of all ActorInfo records in the query using the global executor
func (q actorInfoQuery) CountG(ctx context.Context) (int64, error) {
...
func (q actorInfoQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count actor_info rows")
	}
...
func (q actorInfoQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (q actorInfoQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if actor_info exists")
	}
