...
var CustomerWhere = struct {
	...
	Active:     whereHelperbool{field: "`customer`.`active`"},
...
func (o *Customer) GetStore() *Store {
	if o == nil {
		return nil
	}
...
func (o *Customer) GetPayments() PaymentSlice {
	if o == nil {
		return nil
	}
...
func (o *Customer) GetRentals() RentalSlice {
	if o == nil {
		return nil
	}
...
func (q customerQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Customer, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for customer")
	}
...
func (q customerQuery) All(ctx context.Context, exec boil.ContextExecutor) (CustomerSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to Customer slice")
	}
...
func (q customerQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count customer rows")
	}
...
func (q customerQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if customer exists")
	}
...
func (o *Customer) SetAddressG(ctx context.Context, insert bool, related *Address) error {
...
// Adds o to related.R.Customers.
// Uses the global database handle.
func (o *Customer) SetStoreG(ctx context.Context, insert bool, related *Store) error {
...
// Uses the global database handle.
func (o *Customer) AddPaymentsG(ctx context.Context, insert bool, related ...*Payment) error {
...
// Sets related.R.Customer appropriately.
// Uses the global database handle.
func (o *Customer) AddRentalsG(ctx context.Context, insert bool, related ...*Rental) error {
...
func FindCustomerG(ctx context.Context, customerID uint16, selectCols ...string) (*Customer, error) {
...
func FindCustomer(ctx context.Context, exec boil.ContextExecutor, customerID uint16, selectCols ...string) (*Customer, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from customer")
	}
...
func (o *Customer) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no customer provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into customer")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for customer")
	}
...
func (o *Customer) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update customer, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update customer row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for customer")
	}
...
func (q customerQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for customer")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for customer")
	}
...
func (o CustomerSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in customer slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all customer")
	}
	return rowsAff, nil
}
...
func (o *Customer) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no customer provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("model: unable to upsert customer, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for customer")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for customer")
	}
...
func (o *Customer) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no Customer provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from customer")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for customer")
	}
...
func (q customerQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no customerQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from customer")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for customer")
	}
...
func (o CustomerSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from customer slice")
	}
...
func (o *Customer) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no Customer provided for reload")
	}
...
func (o *CustomerSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty CustomerSlice provided for reload all")
	}
...
func (o *CustomerSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in CustomerSlice")
	}
...
func CustomerExistsG(ctx context.Context, customerID uint16) (bool, error) {
...
func CustomerExists(ctx context.Context, exec boil.ContextExecutor, customerID uint16) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if customer exists")
	}
