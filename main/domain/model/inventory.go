...
func (r *inventoryR) GetFilm() *Film {
	if r == nil {
		return nil
	}
...
func (o *Inventory) GetStore() *Store {
	if o == nil {
		return nil
	}
...
func (r *inventoryR) GetStore() *Store {
	if r == nil {
		return nil
	}
...
func (o *Inventory) GetRentals() RentalSlice {
	if o == nil {
		return nil
	}

	return o.R.GetRentals()
}

func (r *inventoryR) GetRentals() RentalSlice {
	if r == nil {
		return nil
	}
...
// OneG returns a single inventory record from the query using the global executor.
func (q inventoryQuery) OneG(ctx context.Context) (*Inventory, error) {
...
// AllG returns all Inventory records from the query using the global executor.
func (q inventoryQuery) AllG(ctx context.Context) (InventorySlice, error) {
...
// CountG returns the count of all Inventory records in the query using the global executor
func (q inventoryQuery) CountG(ctx context.Context) (int64, error) {
...
func (q inventoryQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (o *Inventory) Store(mods ...qm.QueryMod) storeQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (inventoryL) LoadStore(ctx context.Context, e boil.ContextExecutor, singular bool, maybeInventory interface{}, mods queries.Applicator) error {
	var slice []*Inventory
	var object *Inventory
...
func (inventoryL) LoadRentals(ctx context.Context, e boil.ContextExecutor, singular bool, maybeInventory interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`rental`),
		qm.WhereIn(`rental.inventory_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Inventory) SetFilmG(ctx context.Context, insert bool, related *Film) error {
...
// Adds o to related.R.Inventories.
// Uses the global database handle.
func (o *Inventory) SetStoreG(ctx context.Context, insert bool, related *Store) error {
...
// Sets o.R.Store to related.
// Adds o to related.R.Inventories.
func (o *Inventory) SetStore(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Store) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
// Uses the global database handle.
func (o *Inventory) AddRentalsG(ctx context.Context, insert bool, related ...*Rental) error {
	return o.AddRentals(ctx, boil.GetContextDB(), insert, related...)
}
...
func FindInventoryG(ctx context.Context, inventoryID uint32, selectCols ...string) (*Inventory, error) {
	return FindInventory(ctx, boil.GetContextDB(), inventoryID, selectCols...)
}
...
func (o *Inventory) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *Inventory) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO `inventory` () VALUES ()%s%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for inventory")
	}
...
// UpdateG a single Inventory record using the global executor.
// See Update for more documentation.
func (o *Inventory) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q inventoryQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o InventorySlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Inventory) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateColumns, insertColumns)
}

var mySQLInventoryUniqueColumns = []string{
	"inventory_id",
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *Inventory) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	nzDefaults := queries.NonZeroDefaultSet(inventoryColumnsWithDefault, o)
	nzUniques := queries.NonZeroDefaultSet(mySQLInventoryUniqueColumns, o)
	...
	if !cached {
		...
		cache.query = buildUpsertQueryMySQL(dialect, "`inventory`", update, insert)
		cache.retQuery = fmt.Sprintf(
			"SELECT %s FROM `inventory` WHERE %s",
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for inventory")
	}
	...
	uniqueMap, err = queries.BindMapping(inventoryType, inventoryMapping, nzUniques)
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for inventory")
	}
...
func (o *Inventory) DeleteG(ctx context.Context) (int64, error) {
...
func (q inventoryQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o InventorySlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *Inventory) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no Inventory provided for reload")
	}
...
func (o *InventorySlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty InventorySlice provided for reload all")
	}
...
func InventoryExistsG(ctx context.Context, inventoryID uint32) (bool, error) {
	return InventoryExists(ctx, boil.GetContextDB(), inventoryID)
}
...
func (o *Inventory) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return InventoryExists(ctx, exec, o.InventoryID)
}
