...
func (o *Address) GetCustomers() CustomerSlice {
	if o == nil {
		return nil
	}
...
func (o *Address) GetStaffs() StaffSlice {
	if o == nil {
		return nil
	}
...
func (o *Address) GetStores() StoreSlice {
	if o == nil {
		return nil
	}
...
// CountG returns the count of all Address records in the query using the global executor
...
func (o *Address) SetCityG(ctx context.Context, insert bool, related *City) error {
	return o.SetCity(ctx, boil.GetContextDB(), insert, related)
}
...
// Uses the global database handle.
func (o *Address) AddCustomersG(ctx context.Context, insert bool, related ...*Customer) error {
...
// Sets related.R.Address appropriately.
// Uses the global database handle.
func (o *Address) AddStaffsG(ctx context.Context, insert bool, related ...*Staff) error {
...
// Sets related.R.Address appropriately.
// Uses the global database handle.
func (o *Address) AddStoresG(ctx context.Context, insert bool, related ...*Store) error {
...
func FindAddressG(ctx context.Context, addressID uint16, selectCols ...string) (*Address, error) {
...
func (q addressQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Address) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (q addressQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func AddressExistsG(ctx context.Context, addressID uint16) (bool, error) {
