...
func (o *Actor) GetFilmActors() FilmActorSlice {
	if o == nil {
		return nil
	}
...
// OneG returns a single actor record from the query using the global executor.
func (q actorQuery) OneG(ctx context.Context) (*Actor, error) {
...
func (q actorQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Actor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for actor")
	}
...
// AllG returns all Actor records from the query using the global executor.
func (q actorQuery) AllG(ctx context.Context) (ActorSlice, error) {
...
func (q actorQuery) All(ctx context.Context, exec boil.ContextExecutor) (ActorSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to Actor slice")
	}
...
// CountG returns the count of all Actor records in the query using the global executor
func (q actorQuery) CountG(ctx context.Context) (int64, error) {
...
func (q actorQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count actor rows")
	}
...
func (q actorQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (q actorQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if actor exists")
	}
...
func (o *Actor) AddFilmActorsG(ctx context.Context, insert bool, related ...*FilmActor) error {
...
func FindActorG(ctx context.Context, actorID uint16, selectCols ...string) (*Actor, error) {
	return FindActor(ctx, boil.GetContextDB(), actorID, selectCols...)
}
...
func FindActor(ctx context.Context, exec boil.ContextExecutor, actorID uint16, selectCols ...string) (*Actor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from actor")
	}
...
func (o *Actor) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *Actor) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no actor provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into actor")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for actor")
	}
...
// UpdateG a single Actor record using the global executor.
// See Update for more documentation.
func (o *Actor) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (o *Actor) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update actor, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update actor row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for actor")
	}
...
func (q actorQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (q actorQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for actor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for actor")
	}
...
// UpdateAllG updates all rows with the specified column values.
func (o ActorSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o ActorSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in actor slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all actor")
	}
	return rowsAff, nil
}

// UpsertG attempts an insert, and does an update or ignore on conflict.
func (o *Actor) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *Actor) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no actor provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("model: unable to upsert actor, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for actor")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for actor")
	}
...
func (o *Actor) DeleteG(ctx context.Context) (int64, error) {
...
func (o *Actor) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no Actor provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from actor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for actor")
	}
...
func (q actorQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (q actorQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no actorQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from actor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for actor")
	}
...
func (o ActorSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o ActorSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from actor slice")
	}
...
func (o *Actor) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no Actor provided for reload")
	}
...
func (o *ActorSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty ActorSlice provided for reload all")
	}
...
func (o *ActorSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in ActorSlice")
	}
...
func ActorExistsG(ctx context.Context, actorID uint16) (bool, error) {
	return ActorExists(ctx, boil.GetContextDB(), actorID)
}
...
func ActorExists(ctx context.Context, exec boil.ContextExecutor, actorID uint16) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if actor exists")
	}
