...
func (o *Category) GetFilmCategories() FilmCategorySlice {
	if o == nil {
		return nil
	}
...
func (r *categoryR) GetFilmCategories() FilmCategorySlice {
	if r == nil {
		return nil
	}
...
var (
	categoryAllColumns            = []string{"category_id", "name", "last_update"}
...
func (o *Category) FilmCategories(mods ...qm.QueryMod) filmCategoryQuery {
...
func (categoryL) LoadFilmCategories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
	...
	query := NewQuery(
		...
		qm.WhereIn(`film_category.category_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Category) AddFilmCategoriesG(ctx context.Context, insert bool, related ...*FilmCategory) error {
...
// Appends related to o.R.FilmCategories.
// Sets related.R.Category appropriately.
func (o *Category) AddFilmCategories(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*FilmCategory) error {
	var err error
...
func FindCategoryG(ctx context.Context, categoryID uint8, selectCols ...string) (*Category, error) {
...
func (o *Category) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for category")
	}
...
func (o *Category) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *Category) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for category")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for category")
	}
...
func (o *Category) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no Category provided for reload")
	}
...
func (o *CategorySlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty CategorySlice provided for reload all")
	}
...
func CategoryExistsG(ctx context.Context, categoryID uint8) (bool, error) {
