...
func (o *FilmActor) GetActor() *Actor {
	if o == nil {
		return nil
	}
...
// OneG returns a single filmActor record from the query using the global executor.
func (q filmActorQuery) OneG(ctx context.Context) (*FilmActor, error) {
...
func (q filmActorQuery) One(ctx context.Context, exec boil.ContextExecutor) (*FilmActor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for film_actor")
	}
...
// AllG returns all FilmActor records from the query using the global executor.
func (q filmActorQuery) AllG(ctx context.Context) (FilmActorSlice, error) {
...
func (q filmActorQuery) All(ctx context.Context, exec boil.ContextExecutor) (FilmActorSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to FilmActor slice")
	}
...
// CountG returns the count of all FilmActor records in the query using the global executor
func (q filmActorQuery) CountG(ctx context.Context) (int64, error) {
...
func (q filmActorQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count film_actor rows")
	}
...
func (q filmActorQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (q filmActorQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if film_actor exists")
	}
...
// SetActorG of the filmActor to the related item.
// Sets o.R.Actor to related.
// Adds o to related.R.FilmActors.
// Uses the global database handle.
func (o *FilmActor) SetActorG(ctx context.Context, insert bool, related *Actor) error {
...
// SetFilmG of the filmActor to the related item.
// Sets o.R.Film to related.
// Adds o to related.R.FilmActors.
// Uses the global database handle.
func (o *FilmActor) SetFilmG(ctx context.Context, insert bool, related *Film) error {
...
func FindFilmActorG(ctx context.Context, actorID uint16, filmID uint16, selectCols ...string) (*FilmActor, error) {
	return FindFilmActor(ctx, boil.GetContextDB(), actorID, filmID, selectCols...)
}
...
func FindFilmActor(ctx context.Context, exec boil.ContextExecutor, actorID uint16, filmID uint16, selectCols ...string) (*FilmActor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from film_actor")
	}
...
func (o *FilmActor) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *FilmActor) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no film_actor provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into film_actor")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for film_actor")
	}
...
// UpdateG a single FilmActor record using the global executor.
// See Update for more documentation.
func (o *FilmActor) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (o *FilmActor) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update film_actor, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update film_actor row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for film_actor")
	}
...
func (q filmActorQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (q filmActorQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for film_actor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for film_actor")
	}
...
// UpdateAllG updates all rows with the specified column values.
func (o FilmActorSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o FilmActorSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in filmActor slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all filmActor")
	}
	return rowsAff, nil
}

// UpsertG attempts an insert, and does an update or ignore on conflict.
func (o *FilmActor) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *FilmActor) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no film_actor provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("model: unable to upsert film_actor, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for film_actor")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for film_actor")
	}
...
func (o *FilmActor) DeleteG(ctx context.Context) (int64, error) {
...
func (o *FilmActor) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no FilmActor provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from film_actor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for film_actor")
	}
...
func (q filmActorQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (q filmActorQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no filmActorQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from film_actor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for film_actor")
	}
...
func (o FilmActorSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o FilmActorSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from filmActor slice")
	}
...
func (o *FilmActor) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no FilmActor provided for reload")
	}
...
func (o *FilmActorSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty FilmActorSlice provided for reload all")
	}
...
func (o *FilmActorSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in FilmActorSlice")
	}
...
func FilmActorExistsG(ctx context.Context, actorID uint16, filmID uint16) (bool, error) {
	return FilmActorExists(ctx, boil.GetContextDB(), actorID, filmID)
}
...
func FilmActorExists(ctx context.Context, exec boil.ContextExecutor, actorID uint16, filmID uint16) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if film_actor exists")
	}
