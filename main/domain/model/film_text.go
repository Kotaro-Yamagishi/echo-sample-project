...
// OneG returns a single filmText record from the query using the global executor.
func (q filmTextQuery) OneG(ctx context.Context) (*FilmText, error) {
...
func (q filmTextQuery) One(ctx context.Context, exec boil.ContextExecutor) (*FilmText, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for film_text")
	}
...
// AllG returns all FilmText records from the query using the global executor.
func (q filmTextQuery) AllG(ctx context.Context) (FilmTextSlice, error) {
...
func (q filmTextQuery) All(ctx context.Context, exec boil.ContextExecutor) (FilmTextSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to FilmText slice")
	}
...
// CountG returns the count of all FilmText records in the query using the global executor
func (q filmTextQuery) CountG(ctx context.Context) (int64, error) {
...
func (q filmTextQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count film_text rows")
	}
...
func (q filmTextQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (q filmTextQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if film_text exists")
	}
...
func FindFilmTextG(ctx context.Context, filmID uint16, selectCols ...string) (*FilmText, error) {
	return FindFilmText(ctx, boil.GetContextDB(), filmID, selectCols...)
}
...
func FindFilmText(ctx context.Context, exec boil.ContextExecutor, filmID uint16, selectCols ...string) (*FilmText, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from film_text")
	}
...
func (o *FilmText) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *FilmText) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no film_text provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into film_text")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to populate default values for film_text")
	}
...
// UpdateG a single FilmText record using the global executor.
// See Update for more documentation.
func (o *FilmText) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (o *FilmText) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update film_text, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update film_text row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for film_text")
	}
...
func (q filmTextQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (q filmTextQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for film_text")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for film_text")
	}
...
// UpdateAllG updates all rows with the specified column values.
func (o FilmTextSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o FilmTextSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in filmText slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all filmText")
	}
	return rowsAff, nil
}

// UpsertG attempts an insert, and does an update or ignore on conflict.
func (o *FilmText) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *FilmText) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no film_text provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("model: unable to upsert film_text, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert for film_text")
	}
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to retrieve unique values for film_text")
	}
...
func (o *FilmText) DeleteG(ctx context.Context) (int64, error) {
...
func (o *FilmText) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no FilmText provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from film_text")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for film_text")
	}
...
func (q filmTextQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (q filmTextQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no filmTextQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from film_text")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for film_text")
	}
...
func (o FilmTextSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o FilmTextSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from filmText slice")
	}
...
func (o *FilmText) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: no FilmText provided for reload")
	}
...
func (o *FilmTextSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("model: empty FilmTextSlice provided for reload all")
	}
...
func (o *FilmTextSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in FilmTextSlice")
	}
...
func FilmTextExistsG(ctx context.Context, filmID uint16) (bool, error) {
	return FilmTextExists(ctx, boil.GetContextDB(), filmID)
}
...
func FilmTextExists(ctx context.Context, exec boil.ContextExecutor, filmID uint16) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if film_text exists")
	}
