...
// OneG returns a single filmList record from the query using the global executor.
func (q filmListQuery) OneG(ctx context.Context) (*FilmList, error) {
...
func (q filmListQuery) One(ctx context.Context, exec boil.ContextExecutor) (*FilmList, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for film_list")
	}
...
// AllG returns all FilmList records from the query using the global executor.
func (q filmListQuery) AllG(ctx context.Context) (FilmListSlice, error) {
...
func (q filmListQuery) All(ctx context.Context, exec boil.ContextExecutor) (FilmListSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to FilmList slice")
	}
...
// CountG returns the count of all FilmList records in the query using the global executor
func (q filmListQuery) CountG(ctx context.Context) (int64, error) {
...
func (q filmListQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count film_list rows")
	}
...
func (q filmListQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (q filmListQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if film_list exists")
	}
